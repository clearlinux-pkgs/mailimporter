...
Version  : 22.08.3
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.3/src/mailimporter-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/mailimporter-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/mailimporter-22.08.3.tar.xz.sig
...
%prep
%setup -q -n mailimporter-22.08.3
cd %{_builddir}/mailimporter-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667888764
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MailImporter.so.5.21.3
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.21.3
