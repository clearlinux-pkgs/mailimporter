...
Source0  : https://download.kde.org/stable/applications/19.04.3/src/mailimporter-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/mailimporter-19.04.3.tar.xz.sig
...
%prep
%setup -q -n mailimporter-19.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563044352
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MailImporter.so.5.11.3
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.11.3
