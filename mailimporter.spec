...
Version  : 19.08.0
Release  : 11
URL      : https://download.kde.org/stable/applications/19.08.0/src/mailimporter-19.08.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.0/src/mailimporter-19.08.0.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.0/src/mailimporter-19.08.0.tar.xz.sig
...
%prep
%setup -q -n mailimporter-19.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565928696
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MailImporter.so.5.12.0
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.12.0
