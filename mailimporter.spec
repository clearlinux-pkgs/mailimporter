...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/mailimporter-22.08.0.tar.xz
...
%prep
%setup -q -n mailimporter-22.08.0
cd %{_builddir}/mailimporter-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661555958
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MailImporter.so.5.21.0
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.21.0
