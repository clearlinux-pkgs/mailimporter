...
Version  : 22.12.0
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.0/src/mailimporter-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/mailimporter-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/mailimporter-22.12.0.tar.xz.sig
...
%prep
%setup -q -n mailimporter-22.12.0
cd %{_builddir}/mailimporter-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670543756
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MailImporter.so.5.22.0
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.22.0
