...
Version  : 19.04.0
Release  : 6
URL      : https://download.kde.org/stable/applications/19.04.0/src/mailimporter-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/mailimporter-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/mailimporter-19.04.0.tar.xz.sig
...
%prep
%setup -q -n mailimporter-19.04.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1555691187
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5MailImporter.so.5.11.0
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.11.0
