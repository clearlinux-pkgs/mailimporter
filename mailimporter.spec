...
Version  : 19.12.0
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.0/src/mailimporter-19.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/mailimporter-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/mailimporter-19.12.0.tar.xz.sig
...
%prep
%setup -q -n mailimporter-19.12.0
cd %{_builddir}/mailimporter-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576582779
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mailimporter-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/mailimporter/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/mailimporter-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/mailimporter/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailImporter.so.5.13.0
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.13.0
