...
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/mailimporter-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/mailimporter-21.08.3.tar.xz.sig
...
%prep
%setup -q -n mailimporter-21.08.3
cd %{_builddir}/mailimporter-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636392729
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mailimporter-21.08.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/mailimporter/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/mailimporter-21.08.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/mailimporter/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/mailimporter-21.08.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/mailimporter/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/mailimporter-21.08.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/mailimporter/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/mailimporter-21.08.3/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/mailimporter/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/mailimporter-21.08.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/mailimporter/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/mailimporter-21.08.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/mailimporter/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/mailimporter-21.08.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/mailimporter/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/mailimporter-21.08.3/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/mailimporter/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailImporter.so.5.18.3
/usr/lib64/libKF5MailImporterAkonadi.so.5
/usr/lib64/libKF5MailImporterAkonadi.so.5.18.3
